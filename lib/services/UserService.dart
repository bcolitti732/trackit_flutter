...
class UserService {
  static String get baseUrl {
    if (kIsWeb) {
      ...
      return 'https://ea4-api.upc.edu/api/users';
    } else {
  ...
  static Future<List<Packet>> getAllPackets() async {
    final response = await http.get(
      Uri.parse('https://ea4-api.upc.edu/api/packets'),
    );
    if (response.statusCode == 200) {
  ...
  static Future<void> assignPacketToDelivery(
    ...
    final response = await http.post(
      Uri.parse('https://ea4-api.upc.edu/api/users/assign-packet'),
      headers: {'Content-Type': 'application/json'},
  ...
  static Future<void> updatePacketStatus(
    ...
    final response = await http.put(
      Uri.parse('https://ea4-api.upc.edu/api/packets/$packetId'),
      headers: {'Content-Type': 'application/json'},
