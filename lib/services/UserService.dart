...
class UserService {
  static String get baseUrl {
    if (kIsWeb) {
      ...
      return 'http://192.168.1.44:4000/api/users';
    } else {
  ...
  static Future<List<Packet>> getAllPackets() async {
    final response = await http.get(
      Uri.parse('http://192.168.1.44:4000/api/packets'),
    );
    if (response.statusCode == 200) {
  ...
  static Future<void> assignPacketToDelivery(
    ...
    final response = await http.post(
      Uri.parse('http://192.168.1.44:4000/api/users/assign-packet'),
      headers: {'Content-Type': 'application/json'},
  ...
  static Future<void> updatePacketStatus(
    ...
    final response = await http.put(
      Uri.parse('http://192.168.1.44:4000/api/packets/$packetId'),
      headers: {'Content-Type': 'application/json'},
